...
<head>
    ...
    <link rel="stylesheet" href="stylesheet_produk.css">
</head>
<body>
    <?php
        include "navbar.php";
    ...
    <div class="album py-5">
        <div class="container">
            ...
            if (isset($_POST['cari'])) {
                $cari = $_POST['cari'];
                $query_produk = mysqli_query($koneksi, "select * from produk where nama_produk like '%$cari%' or kategori like '%$cari%' or gender like '%$cari%' or merek like '%$cari%'");
            }
            else{
